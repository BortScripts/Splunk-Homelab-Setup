...
This project documents the development of a personal SIEM homelab built to simulate real-world security monitoring and investigation workflows. The lab focuses on log collection, analysis, and basic incident investigation using Splunk.
